            ...
            <form action="add_obat.php" method="post" name="form1">
                <table width="100%" class="table-bordered" cellpadding="10" border="0">
                    <tr>
                        ...
                        <td><input type="text" class="form-control" name="id_obat"></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <select class="form-control" name="id_pabrik">
                                ...
                                while ($pabrik = mysqli_fetch_array($pabriks)) {
                                    echo"<option>".$pabrik["id_pabrik"]."</option>";
                                }
                                ?>
                            </select>
                        </td>
                        ...
                        <td>
                            <select class="form-control" name="spesifikasi_obat">
                                ...
                                while ($keadaan = mysqli_fetch_array($keadaans)) {
                                    echo"<option>".$keadaan["id_spesifikasi"]."</option>";
                                }
                                ?>
                            </select>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" class="text-center"><input type="submit" class="form-control btn btn-success" name="Submit" value="Tambahkan Obat ke Daftar"></td>
                    </tr>
                </table>
            </form>
        </div>
...
<?php
    if (isset($_POST['Submit'])) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO `obat` (`id_obat`, `nama`, `harga`, `jumlah_barang`, `id_pabrik`, `spesifikasi_obat`) 
                                        VALUES ('$id_obat','$nama','$harga','$jumlah_barang','$id_pabrik','$spesifikasi_obat')")or die(mysqli_error($koneksi));
