...
?>
    <div class="container-fluid">
        <div class="row" style="background-color: aqua; height: 50px; padding:2px 0px 2px 0px;">
            <div class="col-md-3" style="padding-top:4px;"><a class=" btn btn-secondary" href="makanan_add.php" role="button">Tambah Data Makanan</a></div>
                    ...
                    ?>
                        <div class='kotak'>
                                    <table>
                                        ...
                                        <td><img src="<?php echo "makanan/".$makanan['gambar'];?>" style='width:200px;'></td>
                                        </tr>
                                        ...
                                        <tr style='text-align:center'>
                                            ...
                                            <hr style='height:2px;'>
                                            <?php echo"
                                                <a href='makanan_edit.php?nam=".$makanan['id_makanan']."' class='btn btn-info'>Edit</a>"
                                                ?>
                                                <form action="makanan.php" method="POST">
                                                    <input type="hidden" name="delete_id" value="<?php echo $makanan['id_makanan'];?>">
                                                    <input type="hidden" name="delete_gambar" value="<?php echo $makanan['gambar'];?>">
